...
yaaw="&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"button\" value=\" " .. "yaaw" .. " \" onclick=\"window.open('http://aria2.ghostry.cn/yaaw-master')\"/>"
aria2_webui="&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"button\" value=\" " .. "aria2-webui" .. " \" onclick=\"window.open('http://aria2.ghostry.cn/webui-aria2-master/')\"/>"
